...
restart:
	...
	bool processEvents(uint32_t& _width, uint32_t& _height, uint32_t& _debug, uint32_t& _reset, std::wstring &_dropFilePath, MouseState* _mouse)
	{
		s_debug = _debug;
		s_reset = _reset;
